  ...
  return (
    <div className="bg-[#0c1623] grid grid-cols-1 md:grid-cols-2 min-h-[calc(100vh-72px)]">
      ...
      <div className="bg-[#111c2d] relative flex flex-col items-center justify-center min-h-[500px] p-10 md:p-14 gap-7 overflow-hidden">
        ...
        <div
          className="relative w-full max-w-[900px] aspect-square flex items-center justify-center z-10"
          style={{
        ...
        >
          ...
          <Image
            ...
            height={920}
            priority
            className="max-w-[920px] w-full object-contain relative z-[1] animate-[heroFloat_6s_ease-in-out_infinite]"
            style={{
              filter:
